...
\begin{Ztotal}{ 1 | 0 | 1 | 0 | 1 | 0 | 1 | 0 | 0 | 0 }{Z-resultat-navn}{Z1-navn | Z2-navn | Z3-navn | Z4-navn | Z5-navn}
	%{ R1 | X1 | R2 | X2 | R3 | X3 | R4 | X4 | R5 | X5 }{Z resultat navn}{Z1 navn | Z2 navn | Z3 navn | Z4 navn | Z5 navn}
\end{Ztotal}

\begin{LV-Ztotal-max}{ 1 | 5 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 0 }{Z-resultat-navn}{Z1-navn | Z2-navn | Z3-navn | Z4-navn | Z5-navn}
	%{ R1 | X1 | R2 | X2 | R3 | X3 | R4 | X4 | R5 | X5 }{Z resultat navn}{Z1 navn | Z2 navn | Z3 navn | Z4 navn | Z5 navn}
\end{LV-Ztotal-max}
