...
\newcommand\RXet{\frac{(\Ret + j \Xet)}{\nEt}}
\else
\newcommand\Zet{Z_{\Nam[1]}}
\newcommand\RXet{(\Ret + j \Xet)}
\fi

\FPifgt\nTo{1}
\newcommand\Zto{\frac{Z_{\Nam[2]}}{n_{\Nam[2]}}}
\newcommand\RXto{\frac{(\Rto + j \Xto)}{\nTo}}
\else
\newcommand\Zto{Z_{\Nam[2]}}
\newcommand\RXto{(\Rto + j \Xto)}
\fi

\FPifgt\nTre{1}
\newcommand\Ztre{\frac{Z_{\Nam[3]}}{n_{\Nam[3]}}}
\newcommand\RXtre{\frac{(\Rtre + j \Xtre)}{\nTre}}
\else
\newcommand\Ztre{Z_{\Nam[3]}}
\newcommand\RXtre{(\Rtre + j \Xtre)}
\fi

\FPifgt\nFi{1}
\newcommand\Zfi{\frac{Z_{\Nam[4]}}{n_{\Nam[4]}}}
\newcommand\RXfi{\frac{(\Rfi + j \Xfi)}{\nFi}}
\else
\newcommand\Zfi{Z_{\Nam[4]}}
\newcommand\RXfi{(\Rfi + j \Xfi)}
\fi

\FPifgt\nFe{1}
\newcommand\Zfe{\frac{Z_{\Nam[5]}}{n_{\Nam[5]}}}
\newcommand\RXfe{\frac{(\Rfe + j \Xfe)}{\nFe}}
\else
\newcommand\Zfe{Z_{\Nam[5]}}
\newcommand\RXfe{(\Rfe + j \Xfe)}
\fi
